...
const SvgPaymentMaestro = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    width={70}
    height={54}
    viewBox="0 0 70 54"
  ...
  >
    <defs>
      <linearGradient x1="-3.856%" y1="20.245%" x2="117.899%" y2="87.183%" id="payment_maestro_svg__a">
        <stop stopColor="#606060" offset="0%" />
        <stop stopColor="#353141" offset="100%" />
      </linearGradient>
      <linearGradient x1="-3.856%" y1="20.245%" x2="117.899%" y2="87.183%" id="payment_maestro_svg__c">
        <stop stopColor="#EBECED" offset="0%" />
        <stop stopColor="#D6D7E0" offset="100%" />
      </linearGradient>
      <rect id="payment_maestro_svg__b" x={9} y={17} width={70} height={54} rx={8} />
    </defs>
    <g fill="none" fillRule="evenodd">
      <g transform="translate(-9 -17)">
        <use fill="url(#payment_maestro_svg__a)" xlinkHref="#payment_maestro_svg__b" />
        <use fill="url(#payment_maestro_svg__c)" xlinkHref="#payment_maestro_svg__b" />
      </g>
      <g fillRule="nonzero">
