...
function SvgPaymentDiscover(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width={70}
      height={54}
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use
          fill="url(#payment_discover_svg__b)"
          xlinkHref="#payment_discover_svg__a"
        />
        <use
          fill="url(#payment_discover_svg__c)"
          xlinkHref="#payment_discover_svg__a"
        />
        <g mask="url(#payment_discover_svg__d)">
          <g transform="translate(13 23)" fillRule="nonzero">
            ...
            />
            <circle
              fill="url(#payment_discover_svg__e)"
              cx={24.464}
              cy={3.966}
              r={3.928}
            />
            <circle
              fill="url(#payment_discover_svg__f)"
              opacity={0.65}
              cx={24.464}
              cy={3.966}
              r={3.928}
