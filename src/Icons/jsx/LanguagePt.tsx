...
const SvgLanguagePt = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={22} height={16} viewBox="0 0 320 240" {...props}>
    <g fill="none">
      <path fill="#229E45" d="M0 0h320v240H0z" />
      <path fill="#F8E509" d="M160.703 217.968l150.742-97.836-151.654-98.1L8.555 120.367l152.148 97.6z" />
      <path
        fill="#2B49A3"
        d="M226.386 120.002c0 35.165-28.553 63.67-63.773 63.67-35.221 0-63.772-28.505-63.772-63.67 0-35.163 28.552-63.67 63.772-63.67 35.221 0 63.773 28.506 63.773 63.67z"
      />
      ...
      <path
        fill="#FFF"
        d="M225.076 133.016c-33.871-29.754-71.63-44.997-119.34-41.86-1.712 3.278-3.08 6.711-4.236 10.426 56.532-5.393 97.969 19.635 120.685 41.327.971-2.542 2.224-6.375 2.89-9.893z"
      />
    </g>
  </svg>
);

export default SvgLanguagePt;
