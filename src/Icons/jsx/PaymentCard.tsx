...
const SvgPaymentCard = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={70} height={54} viewBox="0 0 70 54" {...props}>
    <defs>
      <linearGradient id="payment_card_svg__a" x1="0%" x2="99.646%" y1="20.245%" y2="79.545%">
        <stop offset="0%" stopColor="#CAD4D6" />
        <stop offset="100%" stopColor="#B4BABF" />
      </linearGradient>
      <linearGradient id="payment_card_svg__b" x1="28.561%" x2="99.536%" y1="47.217%" y2="51.219%">
